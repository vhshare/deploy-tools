...
function genKeyPathMapping(){
  ...
  keyPathMapping.set(Key.esWEB12, ['cmd.exe',  '/c', 'E: && cd E:\\temp_deploy && es-web12.bat']);
  keyPathMapping.set(Key.esAPI12, ['cmd.exe',  '/c', 'E: && cd E:\\temp_deploy && es-api12.bat']);

  keyPathMapping.set(Key.esWEB15, ['cmd.exe',  '/c', 'C: && cd C:\\Users\\Public && es-web15.bat']);
  keyPathMapping.set(Key.esAPI15, ['cmd.exe',  '/c', 'C: && cd C:\\Users\\Public && es-api15.bat']);
  ...
  keyPathMapping.set(Key.esWEB17, ['cmd.exe',  '/c', 'E: && cd E:\\temp_deploy && es-web17.bat']);
  keyPathMapping.set(Key.esAPI17, ['cmd.exe',  '/c', 'E: && cd E:\\temp_deploy && es-api17.bat']);
  ...
  keyPathMapping.set(Key.esWEB23, ['cmd.exe',  '/c', 'E: && cd E:\\temp_deploy && es-web23.bat']);
  keyPathMapping.set(Key.esAPI23, ['cmd.exe',  '/c', 'E: && cd E:\\temp_deploy && es-api23.bat']);
  ...
  keyPathMapping.set(Key.esWEB28, ['cmd.exe',  '/c', 'E: && cd E:\\temp_deploy && es-web28.bat']);
  keyPathMapping.set(Key.esAPI28, ['cmd.exe',  '/c', 'E: && cd E:\\temp_deploy && es-api28.bat']);
  ...
  keyPathMapping.set(Key.esWEB32, ['cmd.exe',  '/c', 'E: && cd E:\\temp_deploy && es-web32.bat']);
  keyPathMapping.set(Key.esAPI32, ['cmd.exe',  '/c', 'E: && cd E:\\temp_deploy && es-api32.bat']);
